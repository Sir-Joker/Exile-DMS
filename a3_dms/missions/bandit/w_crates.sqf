...
for "_i" from 1 to _numberofcrates do
{
	...
	_missionName = "Underwater Treasure";
	_side = "bandit";
		...
		if !(_OK) exitWith
		{
			diag_log format ["DMS ERROR :: Called MISSION crates.sqf with invalid parameters: %1",_this];
		};
	...
	_msgStart = ['#FFFF00',format["some support boxes have been spotted, kill the %1 divers and get them!",_difficulty]];

	// Define Mission Win message
	_msgWIN = ['#0080ff',"Convicts have successfully taken the support box"];
