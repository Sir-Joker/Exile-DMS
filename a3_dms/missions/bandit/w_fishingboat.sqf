...
[
	[
		[(_pos select 0) -50,(_pos select 1)+30,0]
	],
	_group,
	"random",
	_difficulty,
...
//////////////////////////////////////////////////////////////////////////////////////////
//Mission Objects
// Create Buildings - use seperate file
_baseObjs =
[
	"fishingboat_objects",
	_pos
...
_missionObjs =
[
	_baseObjs+[_veh1]+[_veh2],			// armed AI vehicle, base objects, and static guns
	[],							//this is prize vehicle
	[[_crate,_crate_loot_values]]		//this is prize crate
];

// Define Mission Start message
_msgStart = ['#FFFF00',format["A transport ship carrying building material sunk, go take the support box!",_difficulty]];

// Define Mission Win message
_msgWIN = ['#0080ff',"Convicts have successfully get the support box"];

// Define Mission Lose message
_msgLOSE = ['#FF0000',"A patrol escaped with the support box!"];

// Define mission name (for map markers, mission messages, and logging)
_missionName = "Fishingboat";
