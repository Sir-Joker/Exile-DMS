/*
	...
	Mission:
	LCAC
	This Mission have an LCAC prize vehicle
	depends: Burnes LCAC
*/
/** find water position **/
_posSpawnCenter = 
...
_spawnATL = false;
_vehicle = ["Burnes_LCAC_1",[(_pos select 0) -10, (_pos select 1) -10],_pinCode,_spawnATL] call DMS_fnc_SpawnPersistentVehicle;
